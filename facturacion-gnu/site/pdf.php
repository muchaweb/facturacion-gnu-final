            ...
            <table align="right">
                ...
                <tr>
                    <td align="right">
                        ...
                        <br>
                         <span class="palid-text text-right">'.$idFacturacion_folio.'</span>
                    </td>
                </tr>
    ...
    <div style="padding:10px;"> 
        ...
        <table style="width: 99%">
            ...
            <tr>
              ...
              <td align="" class="" style="padding: 10px; border: solid 3px white; height: 20px; vertical-align: top;">m<sup>3</sup></td>
              <td align="" class="" style="padding: 10px; border: solid 3px white; height: 20px; vertical-align: top;">'.$concepto.'</td>
              <td align="" class="" style="padding: 10px; border: solid 3px white; height: 20px; vertical-align: top;">$'.number_format($precioPorUnidad, 2).'</td>
...
<div class="row">
    <div class="col-xs-3">
        <img src="../img/qr_codes/qr_code_'.$idFacturacion_folio.'.png"  alt=""/>
    </div>
    <div class="col-xs-8">
