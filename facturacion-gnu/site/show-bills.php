...
$rfc =  $resultrfc['rfc'];
 ...
 $bills = mysql_query("SELECT DISTINCT facturacion_cliente.email, 
									   ...
									   operacion_cliente.fecha_venta,
									   operacion_cliente.subtotal
			...
			<br><br><br>
				...
				<table class="table table-bordered table-hover" id="example">
					...
					while($resultClient = mysql_fetch_array($bills)){
						...
						$fechaOperacion =   $resultClient['fecha_venta'];
						$totalVenta 	=   $resultClient['subtotal'];
					...
					?>
						...
						<tr>
							...
							<td align="center"><p class="blue strong"><a href="<?php echo $file_pdf; ?>" target="_blank" class="">
							<?php echo $idFacturacion + 1; ?></a></p></td>
							...
							?>
								...
								<a title="Ver PDF" href="<?php echo $file_pdf; ?>" target="_blank"><i class="space-right border space-left normal fa fa-eye"></i>PDF</a> 
