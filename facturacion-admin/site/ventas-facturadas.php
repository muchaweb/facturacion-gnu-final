            ...
            <div class="container col-md-push-2 col-md-8" id="home">
                ...
                <div class="content">
                    ...
                    $billOperation = substr($allBillOperations, 0, -1);
                        ...
                        $url = "http://gnuvehicular.mine.nu:8580/ventas_3meses.php";
                        $ch = curl_init();
                         ...
                         <tbody>
                            <?php 
                                for ($i=1; $i <= $contador; $i++) { 
                                    ...
                                    $folioGestion = mysql_query("SELECT * FROM operacion_cliente WHERE numeroOperacion = '$operacion' ORDER BY idFacturacion DESC");
