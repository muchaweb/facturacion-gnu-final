        ...
        <div class="main-body">
            <div class="container col-md-push-2 col-md-8" id="home">
                ...
                <div class="content">
                    ...
                    ?>
                    <ul class="nav nav-tabs bottom" role="tablist">
                        <li><a href="index.php" class="size-menu"> <i class="fa fa-calendar"></i> Filtro de ventas</a></li>
                        <li class="active"><a href="ventas-1-dia.php" class="size-menu"> <i class="fa fa-calendar"></i> Ventas de 1 día</a></li>
                        </li>
                    </ul>
                    <?php  if($contador > 0){ ?>
