...
if($razonSocial == "VENTA AL PUBLICO EN GENERAL"){
	$mPago = "Efectivo";
}

if($razonSocial  == "PUBLICO EN GENERAL PAGO CON TERMINAL"){
	$mPago = "Tarjeta";
}
$idSale = $_POST['idSale'];
...
foreach ($idSale as $key) {
  ...
  //GUARDAR TIMBRADO EN TXT
    ...
    $updatePath = mysql_query("UPDATE factura_general SET pathXML= '$namexml', pathPDF = '$namePDF' WHERE idFolioFactura = '$idFac1'")or die(mysql_error());
    ...
    <div class="panel-group" id="accordion">
         ...
         <div id="collapseOne" class="panel-collapse collapse in">
             <div class="panel-body">
                 ...
                 class="blue"><?php echo $gnu['rfc_gnu']; ?></label><br>
